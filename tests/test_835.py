...
class TestParsed835(unittest.TestCase):
    ...
    def test_reassociation_trace_number(self):
        ...
        self.assertEqual(
            rtn.originating_company_supplemental_code,
            '000011111')
    ...
    def test_claims(self):
        ...
        self.assertEqual(
            ...
            Decimal('0.0'))
        self.assertEqual(
            c.claim_adjustments.contractual_obligation.amount_1,
            Decimal('0.0'))
