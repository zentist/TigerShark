#
# Generated by TigerShark.tools.convertPyX12 on 2012-07-10 16:29:58.308041
#
from tigershark.X12.parse import Message, Loop, Segment, Composite, Element, Properties
parsed_276_HEADER = Loop( u'HEADER', Properties(looptype=u'wrapper',repeat=u'1',pos=u'015',req_sit=u'R',desc=u'Table 1 - Header'),
Segment( u'BHT', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'020',desc=u'Beginning of Hierarchical Transaction'),
  ...
  Element( u'BHT02', Properties(desc=u'Transaction Set Purpose Code', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=2,
    codes=[u'13'] ) ),
  Element( u'BHT03', Properties(desc=u'Reference Identification', req_sit=u'N', data_type=(u'AN',u'1',u'50'), position=3,
    codes=[] ) ),
...
parsed_276_2100A = Loop( u'2100A', Properties(looptype='',repeat=u'>1',pos=u'050',req_sit=u'R',desc=u'Payer Name'),
...
parsed_276_2100B = Loop( u'2100B', Properties(looptype='',repeat=u'>1',pos=u'050',req_sit=u'R',desc=u'Information Receiver Name'),
...
parsed_276_2100C = Loop( u'2100C', Properties(looptype='',repeat=u'>1',pos=u'050',req_sit=u'R',desc=u'Provider Name'),
...
parsed_276_2100D = Loop( u'2100D', Properties(looptype='',repeat=u'1',pos=u'050',req_sit=u'R',desc=u'Subscriber Name'),
...
parsed_276_2210D = Loop( u'2210D', Properties(looptype='',repeat=u'>1',pos=u'130',req_sit=u'S',desc=u'Service Line Information'),
Segment( u'SVC', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'130',desc=u'Service Line Information'),
  ...
  Element( u'SVC02', Properties(desc=u'Monetary Amount', req_sit=u'R', data_type=(u'R',u'1',u'18'), position=2,
    codes=[] ) ),
  Element( u'SVC03', Properties(desc=u'Monetary Amount', req_sit=u'N', data_type=(u'R',u'1',u'18'), position=3,
    codes=[] ) ),
...
Segment( u'REF', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'140',desc=u'Service Line Item Identification'),
...
Segment( u'DTP', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'150',desc=u'Service Line Date'),
...
parsed_276_2200D = Loop( u'2200D', Properties(looptype='',repeat=u'>1',pos=u'090',req_sit=u'S',desc=u'Claim Submitter Trace Number'),
...
Segment( u'REF', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'100',desc=u'Payer Claim Identification Number'),
  Element( u'REF01', Properties(desc=u'Reference Identification Qualifier', req_sit=u'R', data_type=(u'ID',u'2',u'3'), position=1,
    codes=[u'1K'] ) ),
  Element( u'REF02', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'50'), position=2,
    codes=[] ) ),
...
Segment( u'REF', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'100',desc=u'Institutional Bill Type Identification'),
  Element( u'REF01', Properties(desc=u'Reference Identification Qualifier', req_sit=u'R', data_type=(u'ID',u'2',u'3'), position=1,
    codes=[u'BLT'] ) ),
  Element( u'REF02', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'50'), position=2,
    codes=[] ) ),
...
Segment( u'REF', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'100',desc=u'Medical Record Identification'),
  Element( u'REF01', Properties(desc=u'Reference Identification Qualifier', req_sit=u'R', data_type=(u'ID',u'2',u'3'), position=1,
    codes=[u'EA'] ) ),
  Element( u'REF02', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'50'), position=2,
    codes=[] ) ),
...
Segment( u'REF', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'100',desc=u'Group Number'),
  Element( u'REF01', Properties(desc=u'Reference Identification Qualifier', req_sit=u'R', data_type=(u'ID',u'2',u'3'), position=1,
    codes=[u'LU'] ) ),
  Element( u'REF02', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'50'), position=2,
    codes=[] ) ),
...
Segment( u'AMT', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'110',desc=u'Claim Submitted Charges'),
...
parsed_276_2100E = Loop( u'2100E', Properties(looptype='',repeat=u'1',pos=u'050',req_sit=u'R',desc=u'Dependent Name'),
...
parsed_276_2210E = Loop( u'2210E', Properties(looptype='',repeat=u'>1',pos=u'130',req_sit=u'S',desc=u'Service Line Information'),
Segment( u'SVC', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'130',desc=u'Service Line Information'),
  Composite( u'C003', Properties(req_sit=u'R',refdes='',seq=u'01',desc=u'Composite Medical Procedure Identifier'),
    Element( u'SVC01-01', Properties(desc=u'Product/Service ID Qualifier', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=0,
      codes=[u'AD', u'CI', u'HC', u'ID', u'IV', u'N1', u'N2', u'N3', u'N4', u'ND', u'NH', u'NU', u'RB'] ) ),
...
Segment( u'DTP', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'150',desc=u'Service Line Date'),
  Element( u'DTP01', Properties(desc=u'Date/Time Qualifier', req_sit=u'R', data_type=(u'ID',u'3',u'3'), position=1,
    codes=[u'472'] ) ),
  Element( u'DTP02', Properties(desc=u'Date Time Period Format Qualifier', req_sit=u'R', data_type=(u'ID',u'2',u'3'), position=2,
    codes=[u'RD8'] ) ),
...
parsed_276_2200E = Loop( u'2200E', Properties(looptype='',repeat=u'>1',pos=u'090',req_sit=u'R',desc=u'Claim Submitter Trace Number'),
Segment( u'TRN', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'090',desc=u'Claim Submitter Trace Number'),
  Element( u'TRN01', Properties(desc=u'Trace Type Code', req_sit=u'R', data_type=(u'ID',u'1',u'2'), position=1,
    codes=[u'1'] ) ),
  Element( u'TRN02', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'50'), position=2,
...
parsed_276_2000E = Loop( u'2000E', Properties(looptype='',repeat=u'>1',pos=u'100',req_sit=u'S',desc=u'Dependent Level'),
...
parsed_276_2000D = Loop( u'2000D', Properties(looptype='',repeat=u'>1',pos=u'060',req_sit=u'R',desc=u'Subscriber Level'),
...
parsed_276_2000C = Loop( u'2000C', Properties(looptype='',repeat=u'>1',pos=u'060',req_sit=u'R',desc=u'Service Provider Level'),
...
parsed_276_2000B = Loop( u'2000B', Properties(looptype='',repeat=u'>1',pos=u'060',req_sit=u'R',desc=u'Information Receiver Level'),
...
parsed_276_2000A = Loop( u'2000A', Properties(looptype='',repeat=u'>1',pos=u'010',req_sit=u'R',desc=u'Information Source Level'),
...
parsed_276_DETAIL = Loop( u'DETAIL', Properties(looptype=u'wrapper',repeat=u'>1',pos=u'020',req_sit=u'S',desc=u'Table 2 - Detail'),
parsed_276_2000A,
)
parsed_276_ST_LOOP = Loop( u'ST_LOOP', Properties(looptype=u'explicit',repeat=u'>1',pos=u'020',req_sit=u'R',desc=u'Transaction Set Header'),
...
parsed_276_GS_LOOP = Loop( u'GS_LOOP', Properties(looptype=u'explicit',repeat=u'>1',pos=u'020',req_sit=u'R',desc=u'Functional Group Header'),
...
parsed_276_ISA_LOOP = Loop( u'ISA_LOOP', Properties(looptype=u'explicit',repeat=u'>1',pos=u'001',req_sit=u'R',desc=u'Interchange Control Header'),
...
parsed_276 = Message( u'276', Properties(desc=u'HIPAA Health Care Claim Status Request X093A1-276'),
parsed_276_ISA_LOOP,
)
