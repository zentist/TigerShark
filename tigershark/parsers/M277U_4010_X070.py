...
parsed_277U_2220D = Loop( u'2220D', Properties(looptype='',repeat=u'>1',pos=u'180',req_sit=u'S',desc=u'Service Line Information'),
...
parsed_277U_2200D = Loop( u'2200D', Properties(looptype='',repeat=u'>1',pos=u'090',req_sit=u'S',desc=u'Claim Submitter Trace Number'),
...
parsed_277U_2100E = Loop( u'2100E', Properties(looptype='',repeat=u'1',pos=u'050',req_sit=u'R',desc=u'Dependent Name'),
...
parsed_277U_2200E = Loop( u'2200E', Properties(looptype='',repeat=u'>1',pos=u'090',req_sit=u'R',desc=u'Claim Submitter Trace Number'),
Segment( u'TRN', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'090',desc=u'Claim Submitter Trace Number'),
  Element( u'TRN01', Properties(desc=u'Trace Type Code', req_sit=u'R', data_type=(u'ID',u'1',u'2'), position=1,
    codes=[u'2'] ) ),
  Element( u'TRN02', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'50'), position=2,
...
parsed_277U_2000E = Loop( u'2000E', Properties(looptype='',repeat=u'>1',pos=u'100',req_sit=u'S',desc=u'Dependent Level'),
...
parsed_277U_2000D = Loop( u'2000D', Properties(looptype='',repeat=u'>1',pos=u'060',req_sit=u'R',desc=u'Subscriber Level'),
...
parsed_277U_2000C = Loop( u'2000C', Properties(looptype='',repeat=u'>1',pos=u'060',req_sit=u'R',desc=u'Service Provider Level'),
...
parsed_277U_2000B = Loop( u'2000B', Properties(looptype='',repeat=u'>1',pos=u'060',req_sit=u'R',desc=u'Information Receiver Level'),
...
parsed_277U_2000A = Loop( u'2000A', Properties(looptype='',repeat=u'>1',pos=u'010',req_sit=u'R',desc=u'Information Source Level'),
...
parsed_277U_DETAIL = Loop( u'DETAIL', Properties(looptype=u'wrapper',repeat=u'>1',pos=u'020',req_sit=u'S',desc=u'Table 2 - Detail'),
parsed_277U_2000A,
)
parsed_277U_ST_LOOP = Loop( u'ST_LOOP', Properties(looptype=u'explicit',repeat=u'>1',pos=u'020',req_sit=u'R',desc=u'Transaction Set Header'),
...
parsed_277U_GS_LOOP = Loop( u'GS_LOOP', Properties(looptype=u'explicit',repeat=u'>1',pos=u'020',req_sit=u'R',desc=u'Functional Group Header'),
...
parsed_277U_ISA_LOOP = Loop( u'ISA_LOOP', Properties(looptype=u'explicit',repeat=u'>1',pos=u'001',req_sit=u'R',desc=u'Interchange Control Header'),
...
parsed_277U = Message( u'277', Properties(desc=u'HIPAA Health Care Claim Unsolicited Status Response X070-277U'),
parsed_277U_ISA_LOOP,
)
